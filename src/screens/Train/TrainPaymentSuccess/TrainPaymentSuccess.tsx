...
import { TrainPaymentInfoCard } from "screens/Train/TrainPaymentScreen/TrainPaymentCard";
import { images } from "theme";

interface Props {}

export const TrainPaymentSuccess: React.FC<Props> = () => {
    ...
    <Screen className="flex flex-row">
      <div className="flex flex-col mt-40 mx-12 lg:mx-32 md:mx-24 flex-1">
        ...
        <TrainPaymentInfoCard
          buttonTx="Buy another train card"
